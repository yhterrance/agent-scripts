...
See skill `agent-browser` for the Chrome profile auth setup on this machine. For commands, flags, and triage recipes, run `agent-browser skills get core --full` or `agent-browser --help`.
